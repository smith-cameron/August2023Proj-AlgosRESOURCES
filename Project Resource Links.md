[![hackmd-github-sync-badge](https://hackmd.io/DmvZqhTiQfSYFbgIZtT54Q/badge)](https://hackmd.io/DmvZqhTiQfSYFbgIZtT54Q)

## Wireframes
- [Balsamiq](https://balsamiq.com/)
- [Figma](https://www.figma.com/)
- [wireframe.cc](https://wireframe.cc/)
- [lucidChart](https://www.lucidchart.com/pages/landing?utm_source=google&utm_medium=cpc&utm_campaign=_chart_en_us_mixed_search_brand_exact_&km_CPC_CampaignId=1457964857&km_CPC_AdGroupID=57044764032&km_CPC_Keyword=lucidchart&km_CPC_MatchType=e&km_CPC_ExtensionID=&km_CPC_Network=g&km_CPC_AdPosition=&km_CPC_Creative=442433231234&km_CPC_TargetID=kwd-33511936169&km_CPC_Country=9031299&km_CPC_Device=c&km_CPC_placement=&km_CPC_target=&gclid=Cj0KCQjw2qKmBhCfARIsAFy8buJp2d5aR9kVxu08qyIZEDx35Kl0THBp3_cbUsNmrI9fyFTeaqV5lYcaAnCxEALw_wcB)


## CSS Resources
- [Tailwind](https://www.npmjs.com/)
- [Bootstrap](https://getbootstrap.com/)
- [Color Schemes](https://visme.co/blog/website-color-schemes/?fbclid=IwAR1TaZ7C30iPVY475Z9tgd2OJooGpBd_b6lYO-ohqrSPxJ9jd27UEhJmvZs)
- [Pallette Generator](https://coolors.co/generate)
- [Fonts](https://archetypeapp.com/#)
...
- [Transparent Background](https://www4.lunapic.com/editor/?action=transparent)
...
- [Google Maps APIs by Platform](https://developers.google.com/maps/apis-by-platform)
- [RapidAPI/Free Public APIs for Developers](https://rapidapi.com/collection/list-of-free-apis)
- [mixedanalytics/Big List of Free and Open Public APIs (No Auth Needed)](https://mixedanalytics.com/blog/list-actually-free-open-no-auth-needed-apis/)

## GitHub
- [github](https://github.com/)
- [toptal .gitignore generator](https://www.toptal.com/developers/gitignore)
- [git(1) Manual Page](https://git.github.io/htmldocs/git.html)
- [Coding Dojo - GitHub Review/Tutorials](https://sites.google.com/codingdojo.com/part-time-bb/events/git?authuser=0)
...
### Python
- [Python 3.11.4 docs](https://docs.python.org/3/)
...
- [Generate POJOs from JSON or JSON-Schema](https://www.jsonschema2pojo.org/)
- [Spring JPA query creation](https://docs.spring.io/spring-data/jpa/docs/current/reference/html/#jpa.query-methods.query-creation)
### JavaScript
...
## Post Grad Collaboration
- [Chingu](https://www.chingu.io/)

## Deployment
- [Netlify - React/hmtl](https://app.netlify.com/)
- [Vercel - React/html](https://vercel.com/)
- [Heroku](https://dashboard.heroku.com/apps)
- [AWS](https://aws.amazon.com/)

## Video Resources
- [Login/Registration (auth) w/MERN](https://www.youtube.com/watch?v=ZCJLrFw33Q0)
...
- [FlexBox Zombies - yes it’s free](https://mastery.games/flexboxzombies/)
- [FlexBox Froggy](https://flexboxfroggy.com/)
- [Box Model](https://css-playground.com/view/53/box-model-introduction-playground)
- [CodePen Box Model](https://codepen.io/Ampix0/pen/oWXLeR)
